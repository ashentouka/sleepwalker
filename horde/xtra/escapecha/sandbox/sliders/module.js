{
	...
	const defaults = {
		canvasSelector: '.geetest_canvas_img canvas',
		sliderSelector: '.geetest_slider_button',
		verifyButton: false
	}

	function init({ canvasSelector, sliderSelector, verifyButton }){
		...
		return async function defeatGeeTest(page) {
			if (verifyButton) await clickVerifyButton(page);
	...
	module.exports= function(opts){
		return init(Object.assign({}, defaults, opts))
	}
}